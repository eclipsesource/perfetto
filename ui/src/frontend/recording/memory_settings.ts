  ...
  view({attrs}: m.CVnode<RecordingSectionAttrs>) {
    ...
    return m(
        ...
        m(Slider, {
          ...
          cssClass: `.thin${
              globals(globalsContext).state.recordConfig.hpContinuousDumpsInterval === 0 ?
                  '.greyed-out' :
                  ''}`,
          values: valuesForMS,
          unit: 'ms',
          min: 0,
          disabled: globals(globalsContext).state.recordConfig.hpContinuousDumpsInterval === 0,
  ...
  view({attrs}: m.CVnode<RecordingSectionAttrs>) {
    ...
    return m(
        ...
        m(Slider, {
          ...
          description: 'Time before first dump',
          cssClass: `.thin${
              globals(globalsContext).state.recordConfig.jpContinuousDumpsInterval === 0 ?
                  '.greyed-out' :
                  ''}`,
          values: valuesForMS,
          unit: 'ms',
          min: 0,
          disabled: globals(globalsContext).state.recordConfig.jpContinuousDumpsInterval === 0,
